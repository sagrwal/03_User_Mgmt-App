...
import com.primesoft.service.UserMgmtService;
...
public class UserRestController {
	...
	public ResponseEntity<String> activateAccount(@RequestBody ActivateAccount acc ){
		...
		if(activateUserAcc) {
			...
			return new ResponseEntity<>("Invalid Tempoary Pwd",HttpStatus.BAD_REQUEST);
		}
	}
	...
	public ResponseEntity<String> statusChange(Integer userId, String status){
